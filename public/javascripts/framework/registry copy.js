let panelTypes = {
    ...
    creation : [
        {   // insertCreate
            ...
            id          : 'create',
            description : 'Inserts the creation dialog for one or multiple workspaces',
            inputs : [{
...
let contentOptions = {
    ...
    expandSections : {
        ...
        id          : 'expandSections',
        description : 'Set list of sections (by array of labels) to be expended',
        default     : '',
        type        : 'array'
    },    
    fieldsEx : {
    ...
    sectionsIn : {
        ...
        id          : 'sectionsIn',
        description : 'Set list of sections (by array of labels) to be shown',
        default     : '',
        type        : 'array'
    },  
    sectionsEx : {
        ...
        id          : 'sectionsEx',
        description : 'Set list of sections (by array of labels) to be hidden',
        default     : '',
        type        : 'array'
    },  
    sectionsOrder : {
